    ...
    <div class="d-flex w-100 h-100">
        <div class="d-flex flex-column flex-shrink-0 admin-sidebar" style="width: 300px; height: 100%;">
            ...
            <ul class="nav nav-pills flex-column mt-3 mb-auto">
                <li class="py-2 px-4 {{ request()->routeIs('paket-admin') || request()->routeIs('tambah-paket') || request()->routeIs('detail-paket-admin') || request()->routeIs('tambah-jadwal-destinasi') ? 'menu-active' : 'menu' }}">
                    <a href="{{ route('paket-admin') }}" class="nav-link text-white" aria-current="page">
