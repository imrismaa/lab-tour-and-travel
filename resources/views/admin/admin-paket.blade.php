...
<body>
    <div class="d-flex flex-column flex-shrink-0 p-3 admin-sidebar" style="width: 250px; height: 100%;">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto ms-5">
